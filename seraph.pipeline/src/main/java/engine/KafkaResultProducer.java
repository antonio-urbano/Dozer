...
public class KafkaResultProducer {
     ...
     */
    public void producerResultRecord(String outputTopic, JSONObject cypherResult, Long timestamp) {
        this.kafkaProducer.send(new ProducerRecord<>(outputTopic, 0,timestamp,null, cypherResult.toMap()));
