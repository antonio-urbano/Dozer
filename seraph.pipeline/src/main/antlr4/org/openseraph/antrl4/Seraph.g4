...
oS_Seraph : oS_RegisterQuery | oS_UnregisterQuery ;

oS_RegisterQuery : SP? REGISTER SP? QUERY SP? oS_QueryID SP? '{'  SP?
                      oS_S2R SP?
                      oS_R2R SP?
                      oS_R2S SP?
                     '}' ;

oS_UnregisterQuery : SP? UNREGISTER SP? QUERY SP? oS_QueryID ;

oS_QueryID : IRIREF ;

oS_S2R : FROM SP? STREAM SP? oS_S2R_InputStream SP?
         STARTING SP? FROM SP? oS_S2R_Start SP?
         WITH SP? WINDOW SP? RANGE SP? oS_S2R_Range ;

oS_S2R_InputStream : oS_Stream ;

oS_S2R_Range : oS_S2R_EventRange | oS_S2R_TimeRange ;

oS_S2R_EventRange : oS_EventRange ;
oS_S2R_TimeRange : oS_TimeRange ;

oS_R2S: EMIT SP? oS_R2S_Report SP?
        EVERY SP? oS_R2S_Range SP?
        INTO SP? oS_R2S_OutputStream;

oS_R2S_OutputStream : oS_Stream ;

oS_Stream : IRIREF ;

oS_R2S_Range : oS_R2S_EventRange | oS_R2S_TimeRange ;

oS_R2S_EventRange : oS_EventRange ;
oS_R2S_TimeRange : oS_TimeRange ;

REGISTER : ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'G' | 'g' ) ( 'I' | 'i' ) ( 'S' | 's' )  ( 'T' | 't' ) ( 'E' | 'e' )  ( 'R' | 'r' )    ;

UNREGISTER : ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'G' | 'g' ) ( 'I' | 'i' ) ( 'S' | 's' )  ( 'T' | 't' ) ( 'E' | 'e' )  ( 'R' | 'r' )    ;
...
oS_R2S_Report : oS_R2S_ReportOnEntering | oS_R2S_ReportOnExit | oS_R2S_ReportSnapshot ;

oS_R2S_ReportOnEntering : ON  SP? ENTERING ;
oS_R2S_ReportOnExit : ON  SP? EXIT ;
oS_R2S_ReportSnapshot : SNAPSHOT ;
...
oS_TimeRange : ISO8601_Duration ;

ISO8601_Duration : 'P' ( Digit+ 'Y' )? ( Digit+ 'M' )? ( Digit+ 'D' )? 'T' ( Digit+ 'H' )? ( Digit+ 'M' )? ( Digit+ ( '.' Digit+ )? 'S' )? ;

ISO8601_UTC_Datetime: Digit Digit Digit Digit '-' Digit Digit '-' Digit Digit 'T' Digit Digit ':' Digit Digit ':' Digit Digit 'Z';
...
oS_S2R_StartLatest : LATEST ;
oS_S2R_StartEarliest : EARLIEST ;
oS_S2R_StartTimeInstant : ISO8601_UTC_Datetime ;

EARLIEST : ( 'E' | 'e' ) ( 'A' | 'a' ) ( 'R' | 'r' )  ( 'L' | 'l' ) ( 'I' | 'i' ) ( 'E' | 'e' )  ( 'S' | 's' )  ( 'T' | 't' ) ;

LATEST : ( 'L' | 'l' ) ( 'A' | 'a' )  ( 'T' | 't' )   ( 'E' | 'e' )  ( 'S' | 's' ) ( 'T' | 't' )  ;

oC_Cypher : SP? oC_Statement ( SP? ';' )? SP?;
